                    ...
                    <div className='p-5'>
                        ...
                        <div className='flex gap-5 justify-center items-center mt-5'>
                            <NavLink to='https://github.com/Mmsshakil/blood-donation-manage-client'>
                                <button className='btn btn-info btn-outline rounded-none'>Client Code</button>
                                {/* <MainButton
                                    btnTytle={"Client Code"}
                                ></MainButton> */}
                            </NavLink>
                            <NavLink to='https://github.com/Mmsshakil/blood-donation-manage-server'>
                                <button className='btn btn-info btn-outline rounded-none'>Server Code</button>
                            </NavLink>
                            <NavLink to='https://blood-donor-ade3e.firebaseapp.com/'>
                                <button className='btn btn-info btn-outline rounded-none'>Live Site</button>
                            </NavLink>
